...
- Create a matrix containing information on gene names Gene_1, Gene_2, Gene_3, expression values 1000, 3000, 10000, 12000 and gene lengths 100, 3000, 200, 1000
```{r,message=T}
...
smallGeneMatrix
```
- Create a smaller matrix with just expression and lne columns containing genes longer than 200 and expression greater than 3000.
```{r,message=T}
